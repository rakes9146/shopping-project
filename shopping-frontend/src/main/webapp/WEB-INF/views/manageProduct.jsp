				...
				<div class="panel-body">
					...
					>
						...
						<div class="form-group">
							...
							<label class="control-label col-md-4" for="product">Enter
								Product Name:</label>
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<sf:textarea path="description" id="description" rows="5"
									cols="40" class="form-control"></sf:textarea>
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<sf:input type="text" path="unitPrice" id="price"
									class="form-control"
									placeholder="Please Enter Unit Price in &#8377"></sf:input>
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<sf:input type="number" path="quantity" id="quantity"
									class="form-control"
									placeholder="Please Enter Quantity Available"></sf:input>
       ...
       <div class="modal-dialog" role="document">
           ...
           <div class="modal-body">
               ...
               <div class="form-group">
                  ...
                  <div class="col-md-8">
                    <sf:textarea rows="5" cols="" path="description" class="form-control" /> 
                  </div>
               </div>
